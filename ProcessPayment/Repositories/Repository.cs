...
namespace ProcessPayment.Repositories
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        //Sync Methods for data manipulation to and fro from the DB
        #region "Sync Methods"
        ...
        //Async Methods for data manipulation into and fro from the DB
        ...
        public async Task UpdateRangeSaveAsync(IEnumerable<TEntity> entities)
        {
